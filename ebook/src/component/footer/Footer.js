...
const Footer = () => {
    return (
        <div className="container my-5" style={{ maxWidthwidth:"1700px",backgroudColor:'#7448e3'}}>
      <footer className="text-center text-lg-start text-white" style={{ backgroundColor: '#7448e3' }}>
        ...
        where each book is a key unlocking realms of knowledge and imagination
              ...
              <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <p><a className="text-white">BookShelf</a></p>
              </div>
          ...
          <section className="p-3 pt-0">
            <div className="row d-flex align-items-center">
              <div className="col-md-7 col-lg-8 text-center text-md-start">
                <div className="p-3">
                  © 2020 Copyright:
                  <a className="text-white" href="https://mdbootstrap.com/">Siddhartha</a>
                </div>
              </div>
              <div className="col-md-5 col-lg-4 ml-lg-0 text-center text-md-end">
                <a className="btn btn-outline-light btn-floating m-1 text-white" role="button"><FontAwesomeIcon icon={['fab', 'facebook-f']} /></a>
                <a className="btn btn-outline-light btn-floating m-1 text-white" role="button"><FontAwesomeIcon icon={['fab', 'twitter']} /></a>
                <a className="btn btn-outline-light btn-floating m-1 text-white" role="button"><FontAwesomeIcon icon={['fab', 'google']} /></a>
                <a className="btn btn-outline-light btn-floating m-1 text-white" role="button"><FontAwesomeIcon icon={['fab', 'instagram']} /></a>
              </div>
            </div>
          </section>
        </div>
